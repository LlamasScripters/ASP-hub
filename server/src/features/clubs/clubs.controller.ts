...
clubsRouter.delete("/sessions/:sessionId", async (req: Request, res: Response) => {
  try {
...
// ========== ROUTES PARTICIPANTS ==========
clubsRouter.get("/sessions/:sessionId/participants", async (req: Request, res: Response) => {
  try {
    const list = await clubsService.getSessionParticipants(req.params.sessionId);
...
clubsRouter.post("/sessions/:sessionId/participants", async (req: Request, res: Response) => {
  try {
    const { userId } = req.body;
    const added = await clubsService.addParticipantToSession(req.params.sessionId, userId);
...
clubsRouter.delete("/sessions/:sessionId/participants/:userId", async (req: Request, res: Response) => {
  try {
    await clubsService.removeParticipantFromSession(req.params.sessionId, req.params.userId);
    res.sendStatus(204);
  } catch (error) {
...
clubsRouter.get("/users/:userId/responsibilities", async (req: Request, res: Response) => {
  try {
    const list = await clubsService.getUserResponsibilities(req.params.userId);
    ...
    res.status(500).json({ error: "Erreur lors de la récupération des responsabilités" });
  }
});
...
clubsRouter.post("/responsibilities", async (req: Request, res: Response) => {
  try {
    ...
    res.status(500).json({ error: "Erreur lors de l'attribution de la responsabilité" });
  }
});
...
clubsRouter.put("/:clubId/sections/:sectionId", async (req: Request, res: Response) => {
  try {
    const section = await clubsService.updateSection(req.params.sectionId, req.body);
    res.json(section);
  } catch (error) {
...
clubsRouter.delete("/:clubId/sections/:sectionId", async (req: Request, res: Response) => {
  try {
...
clubsRouter.get("/:clubId/sections/:sectionId/categories", async (req: Request, res: Response) => {
  try {
    const categories = await clubsService.getCategoriesBySection(req.params.sectionId);
    res.json(categories);
  } catch (error) {
...
clubsRouter.post("/:clubId/sections/:sectionId/categories", async (req: Request, res: Response) => {
  try {
...
clubsRouter.put("/:clubId/sections/:sectionId/categories/:categoryId", async (req: Request, res: Response) => {
  try {
    const category = await clubsService.updateCategory(req.params.categoryId, req.body);
    res.json(category);
  } catch (error) {
...
clubsRouter.delete("/:clubId/sections/:sectionId/categories/:categoryId", async (req: Request, res: Response) => {
  try {
...
clubsRouter.get("/:clubId/sections/:sectionId/categories/:categoryId/sessions", async (req: Request, res: Response) => {
  try {
    const limit = parseInt(req.query.limit as string) || 50;
    const sessions = await clubsService.getSessionsByCategory(req.params.categoryId, limit);
