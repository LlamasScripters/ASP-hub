import { u as q, c as z } from "./index-3Axhna2x.js";
import { P as G } from "./index-Bv1xjdPd.js";
import { u as Q } from "./index-CvBT1pZ2.js";
import { c as J } from "./index-DauBq6FI.js";
import { u as W } from "./index-Dl_6cIao.js";
import { u as V, c as p } from "./index-Dqr9Wf5M.js";
import { H as Y, j as d, r as s } from "./index-kb-Ylywn.js";
...
var te = s.forwardRef((e, r) => {
		const {
			...
			g = Y(r, F),
			R = q(w),
			[E, t] = V({ prop: v, defaultProp: C ?? null, onChange: S, caller: I }),
			[i, x] = s.useState(!1),
			u = W(m),
			l = N(c),
			h = s.useRef(!1),
						...
						if (n.target === n.currentTarget && L && !i) {
							...
							if ((n.currentTarget.dispatchEvent(D), !D.defaultPrevented)) {
								const A = l().filter((f) => f.focusable),
									U = A.find((f) => f.active),
									B = A.find((f) => f.id === E),
									H = [U, B, ...A].filter(Boolean).map((f) => f.ref.current);
								M(H, a);
							}
						}
						h.current = !1;
...
function M(e, r = !1) {
	...
	for (const o of e)
		if (
			o === c ||
			(o.focus({ preventScroll: r }), document.activeElement !== c)
		)
			return;
}
function ce(e, r) {
...
var Ie = O,
	be = j;
export { be as I, Ie as R, ve as c };
