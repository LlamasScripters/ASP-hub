import { u as A } from "./index-DauBq6FI.js";
import { H as E, r as a } from "./index-kb-Ylywn.js";
function T(n, e) {
	return a.useReducer((r, t) => e[r][t] ?? r, n);
}
var P = (n) => {
	const { present: e, children: r } = n,
		t = R(e),
		i =
			typeof r == "function" ? r({ present: t.isPresent }) : a.Children.only(r),
		c = E(t.ref, v(i));
	return typeof r == "function" || t.isPresent
		? a.cloneElement(i, { ref: c })
		: null;
};
	...
	return (
		...
		A(() => {
			...
			if (m !== n) {
				...
				n
					? s("MOUNT")
					: u === "none" || (o == null ? void 0 : o.display) === "none"
						? s("UNMOUNT")
						: s(m && f !== u ? "ANIMATION_OUT" : "UNMOUNT"),
					(i.current = n);
			}
		}, [n, s]),
		A(() => {
...
function v(n) {
	var t, i;
	let e =
			(t = Object.getOwnPropertyDescriptor(n.props, "ref")) == null
				? void 0
				: t.get,
