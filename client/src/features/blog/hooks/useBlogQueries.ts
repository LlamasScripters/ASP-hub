...
import {
	...
	type Reaction,
	type Tag,
	type ToggleArticleReactionData,
	type ToggleCommentReactionData,
	type UpdateBlogData,
...
export const commentKeys = {
	...
	count: (articleId: string) =>
		[...commentKeys.counts(), { articleId }] as const,
};
...
export const reactionKeys = {
	...
	articleReactions: (articleId: string) =>
		[...reactionKeys.all, "article", articleId] as const,
	commentReactions: (commentId: string) =>
		[...reactionKeys.all, "comment", commentId] as const,
	userArticleReaction: (articleId: string) =>
		[...reactionKeys.all, "user", "article", articleId] as const,
	userCommentReaction: (commentId: string) =>
		[...reactionKeys.all, "user", "comment", commentId] as const,
};
