...
export function ValidationPage() {
	...
	const { status, applications, refetchStatus } = useFirstLogin();
	...
	return (
		<div className="max-w-2xl mx-auto">
			...
			<FirstLoginProgressBar currentStep={3} title="Validation en cours" />
							...
							<div className="flex items-start gap-3">
								...
								<div>
									...
									<p className="text-sm text-blue-700 dark:text-blue-300 mt-1">
										Nos équipes examinent votre candidature. Vous recevrez une
										notification par email dès que la validation sera terminée.
									</p>
								</div>
							</div>
						</div>
							...
							<div className="flex items-start gap-3">
								...
								<div>
									...
									<p className="text-sm text-green-700 dark:text-green-300 mt-1">
										Félicitations ! Votre adhésion a été validée. Vous pouvez
										maintenant accéder à tous les services d'ASP-hub.
									</p>
								</div>
							</div>
						</div>
							...
							<div className="space-y-3">
								...
								{applications[0].reviewedAt && (
									<div className="flex items-center gap-2">
										...
										<span className="text-sm text-gray-600 dark:text-gray-400">
											Validée le :{" "}
											{new Date(applications[0].reviewedAt).toLocaleDateString(
												"fr-FR",
											)}
										</span>
									</div>
