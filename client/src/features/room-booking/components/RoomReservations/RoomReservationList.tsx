...
export function RoomReservationList({
	...
	const organizeOverlappingRoomReservations = (roomReservations: RoomReservation[]) => {
									...
									{isOpen &&
										roomReservationColumns.map((column, columnIndex) =>
											column.map((roomReservation) => {
												...
												const statusColors = getStatusColor(roomReservation.status);
															...
															<div className="flex justify-between items-end mt-1">
																...
																>
																	<Link
																		...
																		params={{ roomReservationId: roomReservation.id }}
																	>
