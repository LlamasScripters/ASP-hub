			...
			<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
				...
				<Card>
					...
					<CardContent>
						...
						<p className="text-xs text-muted-foreground">
							+2 nouvelles activités ce mois-ci
						</p>
						<div className="mt-4">
						...
						<Card className="lg:col-span-4">
							...
							<CardContent className="pl-2">
								<div className="h-[300px] flex items-center justify-center bg-muted text-muted-foreground rounded-md">
									...
									<span className="ml-2">Graphique des adhésions</span>
								</div>
							</CardContent>
						</Card>
								...
								<div className="space-y-4">
									...
									<div className="flex items-center">
										...
										<div className="flex-1 space-y-1">
											...
											<p className="text-sm text-muted-foreground">
												28 mai 2025 - Piscine municipale
											</p>
										</div>
										<Badge>Sport</Badge>
									</div>
					...
					<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Les 5 derniers adhérents inscrits
								</CardDescription>
							</CardHeader>
							<CardContent>
								<div className="space-y-4">
						...
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Téléchargez les derniers rapports
								</CardDescription>
							</CardHeader>
							<CardContent>
								<div className="space-y-4">
				...
				<TabsContent value="activities" className="space-y-4">
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Gérez les activités et les plannings d'entraînement
							</CardDescription>
						</CardHeader>
						<CardContent>
							<div className="h-[400px] flex items-center justify-center bg-muted text-muted-foreground rounded-md">
								<Calendar className="w-12 h-12" />
								<span className="ml-2">Contenu des activités à venir</span>
							</div>
						</CardContent>
					</Card>
				</TabsContent>
				<TabsContent value="members" className="space-y-4">
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Gérez les profils et les cotisations des adhérents
							</CardDescription>
						</CardHeader>
						<CardContent>
							<div className="h-[400px] flex items-center justify-center bg-muted text-muted-foreground rounded-md">
								<Users className="w-12 h-12" />
								<span className="ml-2">Tableau des adhérents à venir</span>
							</div>
						</CardContent>
					</Card>
				</TabsContent>
				<TabsContent value="projects" className="space-y-4">
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Suivez l'avancement des initiatives sociales
							</CardDescription>
						</CardHeader>
						<CardContent>
							<div className="h-[400px] flex items-center justify-center bg-muted text-muted-foreground rounded-md">
								<TrendingUp className="w-12 h-12" />
								<span className="ml-2">Suivi des projets à venir</span>
							</div>
						</CardContent>
					</Card>
				</TabsContent>
