...
import { CalendarDays, Clock, Filter, MapPin, MoreHorizontal, Plus, Users } from "lucide-react"
import {
    DropdownMenu,
    DropdownMenuContent,
    DropdownMenuItem,
        ...
        <div className="space-y-6">
            <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
                <div>
                    ...
                    <p className="text-muted-foreground">Planifiez et gérez les activités sportives et les installations.</p>
                </div>
                    ...
                    <div className="grid gap-4 md:grid-cols-7">
                            ...
                            <CardContent>
                                ...
                                <div className="mt-6 space-y-4">
                                    ...
                                    {filteredActivities
                                        ...
                                        .map((activity) => (
                                            <div key={activity.id} className="flex items-center p-3 border rounded-md">
                                                ...
                                                <Badge variant={activity.type === "Compétition" ? "default" : "outline"}>{activity.type}</Badge>
                                            </div>
                                        ))}
                                </div>
                            </CardContent>
                        ...
                        <Card className="md:col-span-2">
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="pt-4">
                                    <h3 className="mb-2 text-sm font-medium">Coachs disponibles</h3>
                                    <div className="space-y-3">
                                        {Array.from(new Set(activities.map((a) => a.coach)))
                                            .slice(0, 4)
                                            .map((coach, index) => (
                                                    ...
                                                    <TableCell>
                                                        <div>
                                                            ...
                                                            <div className="flex items-center mt-1">
                                                                <Badge
                                                                    variant={activity.type === "Compétition" ? "default" : "outline"}
                                                                    className="text-xs"
                                                                >
                                                                    {activity.type}
                                                                </Badge>
                                                                <span className="ml-2 text-xs text-muted-foreground">{activity.category}</span>
                                                            </div>
                                                        </div>
                                                    </TableCell>
                                                    <TableCell>
                                                    ...
                                                    <TableCell>
                                                        <div className="flex items-center">
                                                            <Avatar className="h-6 w-6 mr-2">
                                                                <AvatarImage src={`/placeholder.svg?height=24&width=24`} alt={activity.coach} />
                                                                <AvatarFallback>
                                                                    {activity.coach
                                                                        .split(" ")
                                                                        .map((n) => n[0])
                                                    ...
                                                    <TableCell>
                                                        <DropdownMenu>
                                                            ...
                                                            <DropdownMenuContent align="end">
                                                                ...
                                                                <DropdownMenuItem>Gérer les participants</DropdownMenuItem>
                                                                <DropdownMenuSeparator />
                        ...
                        <CardHeader>
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <CardDescription>Gérez les installations disponibles pour les activités</CardDescription>
                                </div>
                                <Button size="sm">
                                    <Plus className="w-4 h-4 mr-2" />
