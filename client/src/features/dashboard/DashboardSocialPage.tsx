...
import { BarChart3, Calendar, Download, FileText, MoreHorizontal, Plus, Users } from "lucide-react"
import {
    DropdownMenu,
    DropdownMenuContent,
    DropdownMenuItem,
...
const socialProjects = [
    {
        ...
        description: "Programme d'aide financière pour l'obtention du permis de conduire pour les jeunes de 18 à 25 ans.",
        status: "En cours",
        progress: 75,
    ...
    },
    {
        ...
        description: "Programme de tutorat et d'aide aux devoirs pour les élèves du primaire et du secondaire.",
        status: "En cours",
        progress: 60,
    ...
    },
    {
        ...
        description: "Accompagnement vers l'emploi par le sport pour les jeunes en difficulté d'insertion.",
        status: "En cours",
        progress: 45,
    ...
    },
    {
        ...
        description: "Accès aux activités sportives pour les personnes en situation de handicap.",
        status: "Planifié",
        progress: 10,
    ...
    },
    {
        ...
        description: "Stages sportifs pendant les vacances scolaires pour les enfants de familles défavorisées.",
        status: "Terminé",
        progress: 100,
        ...
        <div className="space-y-6">
            <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
                <div>
                    ...
                    <p className="text-muted-foreground">Gérez les initiatives sociales et suivez leur impact.</p>
                </div>
                    ...
                    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                        <Card>
                            ...
                            <CardContent>
                                ...
                                <p className="text-xs text-muted-foreground">sur 5 projets au total</p>
                            </CardContent>
                        </Card>
                        <Card>
                            <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
                        ...
                        <Card>
                            ...
                            <CardContent>
                                ...
                                <p className="text-xs text-muted-foreground">Prochain dans 5 jours</p>
                            </CardContent>
                        </Card>
                    </div>
                    ...
                    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
                        <Card className="lg:col-span-4">
                            <CardHeader>
                                ...
                                <CardDescription>État d'avancement des projets sociaux en cours</CardDescription>
                            </CardHeader>
                            <CardContent>
                                <div className="space-y-6">
                                    {socialProjects
                                        ...
                                        .map((project) => (
                                            <div key={project.id} className="space-y-2">
                                                <div className="flex items-center justify-between">
                                                    <div className="space-y-1">
                                                        <div className="flex items-center">
                                                            ...
                                                            <Badge className="ml-2" variant={project.status === "En cours" ? "default" : "outline"}>
                                                                {project.status}
                                                            </Badge>
                                                        </div>
                                                ...
                                                <div className="flex justify-between text-xs text-muted-foreground">
                                                    ...
                                                    <div>
                                                        Bénéficiaires: {project.beneficiaries}/{project.maxBeneficiaries}
                                                    </div>
                                                </div>
                                            </div>
                                        ))}
                        ...
                        <Card className="lg:col-span-3">
                            <CardHeader>
                                ...
                                <CardDescription>Par projet et par tranche d'âge</CardDescription>
                            </CardHeader>
                            <CardContent>
                                    ...
                                    {beneficiaries.slice(0, 5).map((beneficiary) => (
                                        <div key={beneficiary.id} className="flex items-center">
                                            <Avatar className="h-9 w-9">
                                                <AvatarImage src={`/placeholder.svg?height=36&width=36`} alt={beneficiary.name} />
                                                <AvatarFallback>
                                                    {beneficiary.name
                                                        .split(" ")
                                                        .map((n) => n[0])
                                            ...
                                            <div className="ml-4 space-y-1">
                                                <p className="text-sm font-medium leading-none">{beneficiary.name}</p>
                                                <p className="text-sm text-muted-foreground">{beneficiary.project}</p>
                                            </div>
                                            <div className="ml-auto">
                                                <Badge variant={beneficiary.status === "Terminé" ? "outline" : "default"}>
                                                    {beneficiary.status}
                                                </Badge>
                                            </div>
                                        </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <div className="flex-1 space-y-1">
                                            ...
                                            <p className="text-sm text-muted-foreground">22 mai 2025 - Centre culturel</p>
                                        </div>
                                        <Badge variant="outline">Social</Badge>
                                    </div>
                                    <div className="flex items-center">
                                        ...
                                        <div className="flex-1 space-y-1">
                                            <p className="text-sm font-medium leading-none">Réunion des bénéficiaires du permis</p>
                                            <p className="text-sm text-muted-foreground">25 mai 2025 - Salle de réunion</p>
                                        </div>
                                        <Badge variant="outline">Social</Badge>
                                    </div>
                                    <div className="flex items-center">
                                        ...
                                        <div className="flex-1 space-y-1">
                                            <p className="text-sm font-medium leading-none">Forum des métiers du sport</p>
                                            <p className="text-sm text-muted-foreground">30 mai 2025 - Gymnase central</p>
                                        </div>
                                        <Badge variant="outline">Social</Badge>
                                    </div>
                                </div>
                        ...
                        <CardHeader>
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <CardDescription>{socialProjects.length} projets au total</CardDescription>
                                </div>
                                <Button size="sm">
                                    <Plus className="w-4 h-4 mr-2" />
                                    Nouveau projet
                                        ...
                                        {socialProjects.map((project) => (
                                            <TableRow key={project.id}>
                                                <TableCell>
                                                    ...
                                                    <div className="text-sm text-muted-foreground">{project.coordinator}</div>
                                                </TableCell>
                                                <TableCell>
                                                    <Badge
                                                        variant={
                                                ...
                                                <TableCell>
                                                    <DropdownMenu>
                                                        ...
                                                        <DropdownMenuContent align="end">
                                                            ...
                                                            <DropdownMenuItem>Gérer les bénéficiaires</DropdownMenuItem>
                        ...
                        <CardHeader>
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <CardDescription>{beneficiaries.length} bénéficiaires au total</CardDescription>
                                </div>
                                <Button size="sm">
                                    <Plus className="w-4 h-4 mr-2" />
                                    ...
                                    <TableBody>
                                        {beneficiaries.map((beneficiary) => (
                                            <TableRow key={beneficiary.id}>
                                                <TableCell>
                                                    <div className="flex items-center gap-3">
                                                        <Avatar className="h-8 w-8">
                                                            <AvatarImage src={`/placeholder.svg?height=32&width=32`} alt={beneficiary.name} />
                                                            <AvatarFallback>
                                                                {beneficiary.name
                                                                    .split(" ")
                                                                    .map((n) => n[0])
                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="text-sm text-muted-foreground">{beneficiary.contact}</div>
                                                        </div>
                                                    </div>
                                                </TableCell>
                                                ...
                                                <TableCell>
                                                    <div className="flex items-center gap-2">
                                                        <Progress value={beneficiary.progress} className="h-2 w-[60px]" />
                                                        <span className="text-sm">{beneficiary.progress}%</span>
                                                    </div>
                                                </TableCell>
                                                <TableCell>
                                                    <DropdownMenu>
                                                        ...
                                                        <DropdownMenuContent align="end">
                                                            ...
                                                            <DropdownMenuItem>Modifier</DropdownMenuItem>
                                                            <DropdownMenuItem>Mettre à jour la progression</DropdownMenuItem>
                                                            <DropdownMenuItem>Envoyer un message</DropdownMenuItem>
                                                            <DropdownMenuSeparator />
                                                            <DropdownMenuItem className="text-red-600">Retirer du programme</DropdownMenuItem>
                                                        </DropdownMenuContent>
                                                    </DropdownMenu>
                                                </TableCell>
                                            </TableRow>
                ...
                <TabsContent value="reports" className="space-y-4">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Générez des rapports sur l'impact des projets sociaux</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <div className="space-y-4">
                                <div className="grid gap-4 md:grid-cols-2">
                                    <Card>
                                        <CardHeader className="pb-2">
                                            <CardTitle className="text-lg">Rapport d'impact</CardTitle>
                                            <CardDescription>Analyse de l'impact des projets sociaux</CardDescription>
                                        </CardHeader>
                                        <CardContent className="pb-2">
                                            <div className="h-[200px] flex items-center justify-center bg-gray-100 dark:bg-gray-800 rounded-md">
                                                <BarChart3 className="w-12 h-12 text-gray-400" />
                                                <span className="ml-2 text-gray-500">Graphique d'impact</span>
                                            </div>
                                        </CardContent>
                                        <CardFooter>
                                            <Button variant="outline" className="w-full">
                                    ...
                                    <Card>
                                        <CardHeader className="pb-2">
                                            <CardTitle className="text-lg">Statistiques des bénéficiaires</CardTitle>
                                            <CardDescription>Répartition par âge et par projet</CardDescription>
                                        </CardHeader>
                                        <CardContent className="pb-2">
                                            <div className="h-[200px] flex items-center justify-center bg-gray-100 dark:bg-gray-800 rounded-md">
                                                <BarChart3 className="w-12 h-12 text-gray-400" />
                                                <span className="ml-2 text-gray-500">Graphique des statistiques</span>
                                            </div>
                                        </CardContent>
                                        <CardFooter>
                                            <Button variant="outline" className="w-full">
                                ...
                                <div className="border rounded-md">
                                    <Table>
                                        ...
                                        <TableBody>
                                            <TableRow>
                                                <TableCell>
                                                    <div className="font-medium">Rapport trimestriel - T1 2025</div>
                                                </TableCell>
                                            ...
                                            <TableRow>
                                                <TableCell>
                                                    <div className="font-medium">Statistiques des bénéficiaires</div>
                                                </TableCell>
                                            ...
                                            <TableRow>
                                                <TableCell>
                                                    <div className="font-medium">Rapport d'impact - Aide au permis</div>
                                                </TableCell>
                                                <TableCell>PDF</TableCell>
