                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="title" className="text-sm font-medium">
                      Titre de la session <span className="text-destructive">*</span>
                    </Label>
                    <Input
                      id="title"
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Select value={form.type || "entrainement"} onValueChange={(value) => setForm({ ...form, type: value as SessionSport["type"] })}>
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={form.status || "planifie"} onValueChange={(value) => setForm({ ...form, status: value as SessionSport["status"] })}>
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
