...
export function SessionEditPage() {
  const { clubId, sectionId, categoryId, sessionId } = useParams({ from: "/_authenticated/dashboard/clubs/$clubId/sections/$sectionId/categories/$categoryId/sessions/$sessionId/edit" });
  return (
    <div className="p-4">
