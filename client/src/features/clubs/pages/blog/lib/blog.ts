...
export class BlogApi {
  ...
  async updateBlog(id: string, blogData: UpdateBlogData): Promise<{ data: Blog }> {
    const response = await fetch(`${this.baseUrl}/${id}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
...
export class CommentsApi {
  ...
  async getCommentsByArticleId(articleId: string): Promise<{ data: Comment[] }> {
  ...
  async createComment(commentData: CreateCommentData): Promise<{ data: Comment }> {
    const response = await fetch(this.baseUrl, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
  ...
  async updateComment(id: string, commentData: UpdateCommentData): Promise<{ data: Comment }> {
    const response = await fetch(`${this.baseUrl}/${id}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
  ...
  async getCommentsCount(articleId: string): Promise<{ data: { count: number } }> {
...
export class ReactionsApi {
  ...
  async getArticleReactions(articleId: string): Promise<{ data: ArticleReaction[] }> {
  ...
  async getCommentReactions(commentId: string): Promise<{ data: CommentReaction[] }> {
  ...
  async getUserArticleReaction(articleId: string): Promise<{ data: UserReaction | null }> {
  ...
  async getUserCommentReaction(commentId: string): Promise<{ data: UserReaction | null }> {
  ...
  async toggleArticleReaction(data: ToggleArticleReactionData): Promise<{ data: any }> {
  ...
  async toggleCommentReaction(data: ToggleCommentReactionData): Promise<{ data: any }> {
