          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-3">
                <div>
                  <h4 className="text-sm font-medium text-muted-foreground">Identifiant</h4>
                  <p className="text-sm font-mono bg-muted px-2 py-1 rounded">
                    {blog.id}
                  </p>
                </div>
                <div>
                  <h4 className="text-sm font-medium text-muted-foreground">État</h4>
              ...
              <div className="space-y-3">
                ...
                <div>
                  <h4 className="text-sm font-medium text-muted-foreground">Dernière modification</h4>
                  <p className="text-sm">{formatDate(blog.updatedAt)}</p>
                </div>
                {blog.publishedAt && (
                  <div>
                    <h4 className="text-sm font-medium text-muted-foreground">Date de publication</h4>
