...
export const Route = createFileRoute("/_authenticated/first-login-application")(
	{
		component: FirstLoginApplicationPage,
	},
);

function FirstLoginApplicationPage() {
							...
							>
								<div>
									...
									<p className="text-sm text-gray-500 mt-1">
										{form.watch("motivation")?.length || 0} / 50 caractères
										minimum
									</p>
								</div>
								...
								<div>
									...
									<p className="text-sm text-gray-500 mt-1">
										Vous pourrez également télécharger votre certificat médical
										plus tard.
									</p>
								</div>
