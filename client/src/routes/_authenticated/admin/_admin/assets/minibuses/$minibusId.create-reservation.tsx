...
export const Route = createFileRoute(
	...
	component: MinibusReservationCreateRoute,
	errorComponent: ({ error }) => {
		console.error("Error loading minibus for reservation creation:", error);
		return (
			<div className="flex items-center justify-center min-h-[400px]">
				<div className="text-center">
					...
					<p className="text-gray-600 mb-4">
						Impossible de charger le minibus pour créer une réservation.
					</p>
					<button
						type="button"
...
function MinibusReservationCreateRoute() {
	const { minibus } = Route.useLoaderData();
	return <MinibusReservationCreatePage minibus={minibus} />;
}
